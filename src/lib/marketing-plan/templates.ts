  ...
  Platinum: [
    ...
    },
    {
      ...
      activities: [
        ...
        { month: 3, label: 'Newsletter', ownership: 'TIO' },
        { month: 4, label: 'Lead Promo', ownership: 'TIO' },
        { month: 6, label: 'Newsletter', ownership: 'TIO' },
        { month: 7, label: 'Lead Promo', ownership: 'TIO' },
        { month: 9, label: 'Newsletter', ownership: 'TIO' },
        { month: 10, label: 'Lead Promo', ownership: 'TIO' },
        { month: 12, label: 'Newsletter', ownership: 'TIO' },
      ],
    },
    {
    ...
    },
    {
      ...
      sortOrder: 6,
      activities: [
        { month: 3, label: 'GDP Visit', ownership: 'PRACTICE' },
        { month: 6, label: 'Community Event', ownership: 'PRACTICE' },
        { month: 9, label: 'GDP Visit', ownership: 'PRACTICE' },
